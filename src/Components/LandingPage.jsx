        ...
        <div className='sm:flex sm:flex-row flex-col h:auto'>
          ...
          <div id='Social' className='w-1/3 py-5 pt-5 '>
            ...
            <div className='flex flex-row sm:ml-0 ml-2'>
              <a href="https://www.linkedin.com/in/aritra-mukhopadhyay-042a3127a/" target='blank'><svg className='m-5' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="70" height="70" viewBox="0 0 48 48">
              ...
              <a href="#"><svg className='bg-white sm:m-7 m-7 mr-5' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
