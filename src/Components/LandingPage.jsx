    ...
    <div className="bg-black font-mono">
      <nav className="h-18 bg-black top-0 sticky z-50 text-orange-400 border-b-2 border-orange-400">
        <ul className="flex flex-row justify-end">
          <h1 className="p-4 mr-auto ml-4 font-semibold text-orange-400 hover:text-white text-xl sm:text-2xl">
            <a href="#">LINKAID</a>
          </h1>
          <li className="hidden sm:inline sm:p-5 mr-4 hover:bg-orange-400 hover:text-white font-semibold">
            {" "}
            <a href="#"> Home</a>
          </li>
          <li className="hidden sm:inline p-5 mr-4 hover:bg-orange-400 hover:text-white font-semibold">
            {" "}
          ...
          <li className="sm:hidden inline mt-2 mr-4">
      ...
      <div className="flex">
        <div className="sm:hidden flex flex-col">
          <div className=" w-[100vw] h-auto block sm:hidden">
            <img
              className="shadow-slate-800 m-auto w-[90vw] "
              src={img1}
              alt=""
            />
          </div>
          <div className="block sm:hidden w-[100vw] h-auto">
            <div className="">
              <h1 className="text-center p-28 text-5xl font-bold mt-0 z-1 text-white">
                One Stop{" "}
            ...
            <div className="flex flex-col">
              <Link to="/auth" className="m-auto">
                <button className="border-2 border-black rounded-lg border-solid text-xl p-5 pl-28 pr-28 pt-3 pb-3 mt-5 bg-orange-400 text-white hover:bg-white hover:text-orange-400">
                  {" "}
                  Sign In
                </button>
              </Link>
        ...
        <div className="hidden sm:block sm:w-1/2 sm:h-[630px]">
          <div className="">
            <h1 className="p-28 text-6xl font-bold mt-0 z-1 text-white">
              {" "}
              One Stop{" "}
              <span className="bg-orange-400 text-transparent bg-clip-text">
                Solution
      ...
      <div id="Details" className="sm:flex sm:flex-row flex flex-wrap">
        ...
        <div className="h-auto sm:h-[640px] w-[100vw] sm:w-1/3 bg-white text-center p-10 sm:text-center m-auto sm:pt-28 sm:pr-14">
          <p className="text-xl">
            Our service specializes in bridging the gap between schools and NGOs
            to address and resolve their unique challenges. By leveraging our
            extensive connections and understanding of both sectors, we
            facilitate strategic partnerships and collaborations that amplify
            the impact of NGOs. We work closely with each NGO to identify their
            specific needs and then connect them with organizations that offer
            relevant expertise, resources, or support. This collaborative
            approach not only helps NGOs overcome obstacles but also fosters a
            synergistic environment where collective efforts lead to innovative
            solutions and enhanced outcomes for the communities they serve.
          </p>
        </div>
      </div>
      <div className="bg-white">
      ...
      <footer id="contact" className="sm:bg-black">
        <div className="sm:flex sm:flex-row flex-col h:auto">
          <div className="p-20 py-5 pl-10 text-white h-52 w-[100vw] sm:h-[36vh] sm:w-1/3 line-clamp-1">
            <h1 className="text-4xl font-semibold text-orange-400 leading-relaxed">
              Stay In Touch
            </h1>
            <p className="leading-7 text-lg">
              To get the best services available
            </p>
            <p className="leeading-7 text-lg">
              Solving problems by bridging the gap between solvers and sufferers
            </p>
          </div>
          <div className="text-white py-5 sm:pt-6 w-1/3 ml-10">
            <p>
              <span className="text-orange-400 leading-loose text-xl">
                Contact No -{" "}
              </span>
              <span className="text-xl">790826xxxx</span>
            </p>
            <p>
              <span className="text-orange-400 leading-loose text-xl">
                Email Id -{" "}
              </span>
              <span className="text-xl">ngoservices1@gmail.com</span>
            </p>
            <p>
              <span className="text-orange-400 leading-loose text-xl">
                Address -
              </span>
              <span className="text-xl"> Crater Pally,Mars</span>
            </p>
          </div>
          <div id="Social" className="w-1/3 py-5 pt-5 ">
            <h1 className="text-2xl font-semibold pl-10 text-orange-400">
            ...
            <div className="flex flex-row sm:ml-0 ml-2">
              ...
              <a href="https://x.com/Status_Code_" target="_blank">
                <svg
                  className="bg-white sm:m-7 m-7 mr-5"
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
                  width="50"
